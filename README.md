...
Тесты и Результаты
### v3.14 — "Survival of the Fittest" (09–10.2025)

| Метрика              | v3.14         | v3.0         | Прирост      |
|----------------------|---------------|--------------|--------------|
| Прибыль              | **$2 754**    | $1 792       | **+54%**     |
| Баланс               | $12 605       | $11 792      | +813$        |
| Комиссии             | -$148         | -$352        | **-58%**     |
| Сделок               | 333           | 268          | +24%         |
| Средний профит       | **$8.27**     | $6.69        | **+23%**     |
| Recovery Factor      | **~2.3**      | 1.28         | **+80%**     |

**Адаптивный порог + equity stop от вчера = +54% профита, -58% комиссий, DD ниже на 15%**

> "Рынок 2025 года — это мясорубка. v3.14 — это EA, который вышел из неё с прибылью. Остальные — в утиле."
